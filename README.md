...
- [StackMask](https://github.com/WKL-Sec/StackMask) * (will add later)
-  [no-alloc-no-problem-leveraging-program-entry-points-for-process-injection](https://bohops.com/2023/06/09/no-alloc-no-problem-leveraging-program-entry-points-for-process-injection/) * (will add later)
- [import_dll_injection](https://www.x86matthew.com/view_post?id=import_dll_injection) * (will add later)
